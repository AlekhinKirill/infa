...
class supertarget(target):
  def __init__(self):
        """Инициализация класса supertarget (дочернего от target) - цели в форме квадрата,при попадании в которую появляется новая цель меньшего размера, в которую сложнее попасть."""
        self.points = 0
        self.live = 1
