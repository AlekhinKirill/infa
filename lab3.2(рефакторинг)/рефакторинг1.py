...
class GameManager:
    def __init__(self, game_window, array_house, array_car, array_cloud):
        '''
          Функция инициализирует класс из массивов array_house, array_car, array_cloud.
          Параметры:
             game_window(pygame.Rect): фон
             array_house(array): массив домов
             array_car(array): массив машин
             array_cloud(array): массив облаков
          Возвращаемые значения:
            Инициализирует класс GameManager
        '''
    ...
    def redraw(self):
        '''
          Функция перерисовывает фон.
          Параметры:
             self(class GameManager): объект класса GameManager
          Возвращаемые значения:
            Pigame.Rect: Выводит новый перерисованный фон
        '''
...
class House:
    def __init__(self, game_window, count, color, x, y, h, w):
        '''
          Функция инициализирует класс  домов.
          Параметры:
             game_window(pygame.Rect): фон
             count(int): число домов
             color(tuple): цвет домов
             x(int): абсцисса домов
             y(int): ордината домов
             h(int): высота дома
             w(int): ширина дома
          Возвращаемые значения:
            Инициализирует класс House
        '''
        self.color = color
        self.x = x
        self.y = y
    ...
    def __draw(self):
        '''
          Функция рисует дом на экране.
          Параметры:
             self(House): объект класса House
          Возвращаемые значения:
            Pigame.Rect: Выводит дом на экран
        '''
...
class Car:
    '''
      Функция инициализирует класс машин.
      Параметры:
         game_window(pygame.Rect): фон
         count(int): число домов
         color_corpus(tuple): цвет машин
         start_x(int): абсцисса домов
         start_y(int): ордината домов
         type_window(array): выбор вида окон
         type_wheel(array): выбор вида колес
      Возвращаемые значения:
        Инициализирует класс Car
    '''
    ...
    def draw(self):
        '''
          ...
          Параметры:
             self(car): объект класса car
          Возвращаемые значения:
            Pigame.Rect: Выводит машину на экран
        '''
        try:
...
class Cloud:
    def __init__(self, game_window, count, x, y, h, w):
        '''
          Функция инициализирует класс  облаков.
          Параметры:
             game_window(pygame.Rect): фон
             count(int): число облаков
             color(tuple): цвет облаков
             x(int): абсцисса облака
             y(int): ордината облака
             h(int): высота облака
             w(int): ширина облака
          Возвращаемые значения:
            Инициализирует класс Cloud
        '''
    ...
    def __draw(self):
        '''
          Функция рисует облако на экране.
          Параметры:
             self(cloud): объект класса cloud
          Возвращаемые значения:
            Pigame.Rect: Выводит облако на экран
        '''
        try:
            self.surface = pygame.Surface((600,800), pygame.SRCALPHA)
    ...
    def set_new_color_pos(self):
        '''
          Функция меняет цвет облаков.
          Параметры:
            self(cloud): объект класса cloud
          Возвращаемые значения:
            Pigame.Rect: Выводит облако нового цвета на экран
        '''
        for i in range(self.k):
